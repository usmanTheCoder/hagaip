...
import { getDesignData } from "../../toolkit/slices/designSlice";
import { getSingleFormData } from "../../toolkit/slices/formSlice";

const Modal = ({ setModal, setFormModal }) => {
  const { userForms } = useSelector((state) => state.form);
